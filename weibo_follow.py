...
def main():
    try:
        # 爬取关注列表的user_id
        user_id = int('1765809461')
        cookie = {'Cookie': 'SCF=AhmKZWtnbc5C63qgdDMIadeiZuwb_K3FqfgSnp0idgzbLTmy2ZmiheNmpu4P7MNy6Vp-JJIVJGRYYWcGkRsxMak.; SUB=_2A25K4-QDDeRhGeFH4lIV9y_NzT2IHXVpgXnLrDV6PUJbktANLU_9kW1Negz0oCGV_HEaOY5stZli9qJoG5Iy2YEr; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WWz684uXrVRUOViMg0Z7IAU5NHD95QN1K.7ShMpeKqpWs4DqcjMi--NiK.Xi-2Ri--ciKnRi-zNS0.4ehBNeK2ceBtt; SSOLoginState=1743230035; ALF=1745822035; _T_WM=88859601437; XSRF-TOKEN=db4353; WEIBOCN_FROM=1110006030; MLOGIN=1; M_WEIBOCN_PARAMS=luicode%3D20000174%26uicode%3D20000174'}
